...
namespace sdkImages.Scenarios
{
    public partial class PinchAndZoom : PhoneApplicationPage
    {
        ...
        void OnManipulationDelta(object sender, ManipulationDeltaEventArgs e)
        {
            if (e.PinchManipulation != null)
            {
                ...
                if (!_pinching)
                {
                    ...
                    _relativeMidpoint = new Point(center.X / _4MESIMERI.ActualWidth, center.Y / _4MESIMERI.ActualHeight);

                    var xform = _4MESIMERI.TransformToVisual(viewport);
        ...
        {
            _bitmap = (BitmapImage)_4MESIMERI.Source;
